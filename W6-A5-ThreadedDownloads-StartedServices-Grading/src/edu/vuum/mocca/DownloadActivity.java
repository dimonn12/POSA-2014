  ...
  static class MessengerHandler extends Handler {
    ...
    public void handleMessage(final Message msg) {
      ...
      if (activity != null) {
        ...
        //        ImageView mImageView = (ImageView)activity.findViewById(R.id.imageView1);
        String str = (String)msg.getData().get(DownloadUtils.PATHNAME_KEY);
        activity.displayBitmap(str);
