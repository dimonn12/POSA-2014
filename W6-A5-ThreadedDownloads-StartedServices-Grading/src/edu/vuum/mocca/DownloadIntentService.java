...
public class DownloadIntentService extends IntentService {
   ...
   * Pattern.
   */
  public static Intent makeIntent(final Context context, final Handler handler, final String uri) {
  ...
  protected void onHandleIntent(final Intent intent) {
    ...
    Messenger msg = (Messenger)intent.getParcelableExtra(DownloadUtils.MESSENGER_KEY);
    DownloadUtils.downloadAndRespond(this, intent.getData(), msg);
  }
}
