...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        private SimpleSemaphore[] semaphoreArray;
        ...
        public PlayPingPongThread(String stringToPrint,
                                  ...
                                  int maxIterations) {
            // TODO - You fill in here.
     	   this.stringToPring = stringToPrint;
     	   mMaxLoopIterations = maxIterations;
     	   semaphoreArray = new SimpleSemaphore[]{semaphoreOne, semaphoreTwo};
        }
        ...
        public void run() {
     	   ...
     	   {
     		   acquire();
     		   System.out.println(stringToPring + "(" + (i+1) + ")");
     		   release();
     	   }
     	   mLatch.countDown();
        }
    ...
    public static void process(String startString, 
        ...
        PlayPingPongThread ping = new PlayPingPongThread(pingString, pingSema, pongSema, mMaxIterations/*
                                                          * TODO - You fill in
                                                          * here
                                                          */);
        PlayPingPongThread pong = new PlayPingPongThread(pongString, pongSema, pingSema, mMaxIterations/*
                                                          * TODO - You fill in
                                                          * here
                                                          */);
